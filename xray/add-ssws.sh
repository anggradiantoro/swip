...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/anggradiantoro/swip/perizinan/main/main/allow > /root/tmp
...
Name=$(curl -sS raw.githubusercontent.com/anggradiantoro/swip/main/main/allow | grep $MYIP | awk '{print $2}')
