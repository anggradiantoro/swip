...
Name=$(curl -sS https://raw.githubusercontent.com/anggradiantoro/swip/main/main/allow | grep $MYIP | awk '{print $2}')
...
cd
MYIP=$(curl -sS ipv4.icanhazip.com)
NameUser=$(curl -sS https://raw.githubusercontent.com/anggradiantoro/swip/main/main/allow | grep $MYIP | awk '{print $2}')

cekdata=$(curl -sS https://raw.githubusercontent.com/anggradiantoro/userbackup/main/$NameUser/$NameUser.zip | grep 404 | awk '{print $1}' | cut -d: -f1)
...
wget -q -O /root/backup/backup.zip "https://raw.githubusercontent.com/anggradiantoro./userbackup/main/$NameUser/$NameUser.zip" &> /dev/null
